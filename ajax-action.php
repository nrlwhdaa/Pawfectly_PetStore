...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		?>
				...
				<td align="center"><a onClick="cartAction('remove','<?php echo $item["code"]; ?>')" class="btnRemoveAction cart-action"></a></td>
				</tr>
				<?php
...
<td align=right><?php echo "RM". number_format($item_total,2); ?></td>
<td></td>
</tr>
</tbody>
</table>		
